...
static struct msm_camera_i2c_reg_array tps61310_high_1A_array[] = {
	{0x05,0x6f},
	{0x01,0xbf},  // 9f->800mA led2
	{0x02,0x84},  //100x2mA led1+3
};
		...
		const struct i2c_device_id *id)
{
	...
	TPS61310_DBG("%s custom_current %d\n", __func__, custom_current);
      if(custom_current == 875)
            tps61310_high_array[2].reg_data = 0x82;   //PD1523A increase main flash high 875mA
      else if(custom_current == 1000)
            tps61310_high_setting.reg_setting = tps61310_high_1A_array;
