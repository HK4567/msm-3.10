 ...
 * 
 * Author: xuguodong  <xuguoqong@vivo.com.cn>
 *
...
#define DEFAULT_STRONG_SUNLIGHT   45000
...
*/
#define alfa1					2624//0.00585
#define alfa2					1646//0.008525
#define alfa3					6565//0.001853
#define alfa4					720//0.001853

#define beta1					2883
#define beta2					439//-0.013425
#define beta3					8777//-0.002305
#define beta4					878//-0.002305
...
#define RATIO_FIRST_BOUND		40//0.2
#define RATIO_SECOND_BOUND	 	59//0.6
#define RATIO_THIRD_BOUND		74//0.8
#define RATIO_FOURTH_BOUND      82
...
{	 
	...
	printk(KERN_INFO TAGI "xuguodong befor lux = %lld\n",lux);
...
static int gp2ap008t_get_ps_value(struct gp2ap008t_priv *obj, u16 ps)   //xuling: this function only used in intterupt now
{
	int val;
...
static void gp2ap008t_eint_work(struct work_struct *work)   //xuling: must have a mutex lock between intterrupt and data getting
{
...
int gp2ap008t_enable_eint(struct gp2ap008t_priv *obj, int enable)
{
	...
	printk(KERN_INFO TAGI " gp2ap008t_enable_eint enable = %d\n",enable);
       ...
       if(enable) {
		printk(KERN_INFO TAGI "xuguodong in = 0x%x out = 0x%x\n",atomic_read(&obj->ps_in_threshold),atomic_read(&obj->ps_out_threshold));
