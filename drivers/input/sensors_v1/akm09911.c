	...
	struct i2c_client *client)
{
	...
	if ((akm->sense_info[0] != AK09911_WIA1_VALUE) ||
		...
		printk(KERN_ERR TAGI
			"%s: The device is not AKM09911 Compass.", __func__);
		return -ENXIO;
	}
...
*/
	...
	printk(KERN_ERR TAGI "akm09911 successfully probed.\n");
	return 0;
...
exit1:
exit0:
	printk(KERN_ERR TAGI "akm09911 probed error.\n");
	return err;
}
...
static int akm_compass_remove(struct i2c_client *client)
{
	...
	kfree(akm);
	printk(KERN_INFO TAGI "akm09911 successfully removed.");
	return 0;
}
